...
export const Audio = ({
  ...
  const { selectedSttProvider, hyperlyApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(hyperlyApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          hyperlyApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
